<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form " enctype="multipart/form-data" method="post" action="?p=candidat#vues">
				<?php
				if(isset($_POST['register']))
				{
					...
					$candidat=new Candidat(NULL,$_POST['nationality'],$_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['password'],$path);
					$candidat->add($conn);
					$candidat->consult($conn,0,"where email='".$_POST['email']."'");
					header("Location: index.php?p=login&id=".$candidat->id."#vues");
				}
				else
				echo'<span class="login100-form-title">Create your account</span>';
				?>
