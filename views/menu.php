	                            ...
	                            <div class="user-panel">
	                                <div class="row">
                                            <div class="sidebar-userpic">
                                                <img src="assets/img/avat.jpg" class="img-responsive" style="width:150px;"> </div>
                                        </div>
                                        <div class="profile-usertitle">
                                            <div class="sidebar-userpic-name"> Hussaini Madjid</div>
                                            <div class="profile-usertitle-job">TEL:+49 179 5999999 </div>
                                        </div>
                                        <div class="sidebar-userpic-btn">
									        <a class="tooltips" href="index.php?p=profil" data-placement="top" data-original-title="Profile">
									        	<i class="material-icons">person_outline</i>
									        </a>
									        <a class="tooltips" href="login.php?logout" data-placement="top" data-original-title="Déconnecter">
