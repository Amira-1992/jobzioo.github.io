      ...
      <div class="container">
        <div class="st-top-header-in">
          <ul class="st-top-header-list">
            ...
            {
              ?>
             <a class="btn btn-sm btn-info" href="index.php?logout" class="st-smooth-move" style="color:white;"><i class="fa fa-sign-out"></i>Sign out</a></li>
              <img src="<?php echo $candidat->picture; ?>" width="45" height="45"/>
              <?php echo "<span style='margin-top:4px;'>".$candidat->first_name."&nbsp;".$candidat->last_name."</span>"; 
              
            }
            else
            {
              ?>
            <a class="btn btn-sm btn-info" data-toggle="modal" data-target="#myModal" class="st-smooth-move" style="color:white;"><i class="fa fa-sign-in"></i>Sign in</a>
              <?php
            }
            ?>
          </ul>
    ...
    <div class="st-main-header" >
      <div class="" style="width:100%;">
        <div class="st-main-header-in">
          <div class="st-main-header-left" style="margin-left:3%">
            <a class="st-site-branding" href="index.php">
                <img src="assets/img/logo2.png" style="height:80px;" alt="Medica Recruiting">
            </a>
          ...
          <div class="st-main-header-right" >
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                <li><a href="index.php#vues" class="">Home</a></li>
                <li><a href="#about" class="st-smooth-move">About us</a></li>
                <li class="menu-item-has-children"><a href="#register" class="st-smooth-move">Jobseekers</a>
                </li>
                <li class="menu-item-has-children"><a href="#" class="st-smooth-move">Recruiters</a>
                  <ul>
                      <li><a href="blog-sidebar.html">Hospitals</a></li>
                  </ul>
                </li>                                  
                <li class="menu-item-has-children"><a href="#price" class="st-smooth-move">Our platform</a>
                  <ul>
                    
                    <li><a href="hospital/" target="_new">Plattform Partners </a></li>
                  </ul>                
                </li>
                ...
                <li><a href="#vues" class="st-smooth-move">Partner Request</a></li>               
                <li><a href="#contact" class="st-smooth-move">Contact</a></li>
                <li></li>
              </ul>
              <div class="dropdown">
                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-globe fa-spin"></i>  Languages
                </button>
